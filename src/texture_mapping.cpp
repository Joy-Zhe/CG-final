...
const std::string newmodelRelPath = "obj/castle.obj";
...
TextureMapping::TextureMapping(const Options& options) : Application(options) {
    ...
    _sphere.reset(new newmodel(getAssetFullPath(newmodelRelPath)));
    _sphere->transform.scale = glm::vec3(0.08f, 0.08f, 0.08f);
...
void TextureMapping::initCheckerShader() {
    ...
    const char* fsCode =
        ...
        "void main() {\n"
        // ���㵱ǰ�����Ӧ�����̸�
        "vec2 checkerCoord = floor(fTexCoord * material.repeat);\n"
        // ʹ�� mod() �����жϵ�ǰ���̸��Ƿ�Ϊż��
        "bool isEven = mod(checkerCoord.x+checkerCoord.y,2.0)==0;"
        // ʹ�����������ѡ����ȷ����ɫ
